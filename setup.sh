...
echo "Next steps:"
echo ""
echo "  ${BOLD}IMPORTANT: Do NOT use Expo Go — use EAS build instead${RESET}"
  echo "  This app uses native modules (mic, location) that Expo Go does not support."
  echo ""
  echo "  ${BOLD}Build the real app:${RESET}"
echo "  npx expo start"
