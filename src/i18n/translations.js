...
export const translations = {
  en: {
    ...
    listening: 'Listening...',
    askFern: 'Ask Fern',
    askFernError: "Fern couldn't reply — try again",
    fernVoiceOn: 'Fern\'s voice: on',
    fernVoiceOff: 'Fern\'s voice: off',
    statDinners: 'Dinners',
  ...
  es: {
    ...
    askFernError: 'Fern no pudo responder — inténtalo de nuevo',
    fernVoiceOn: 'Voz de Fern: activada',
    fernVoiceOff: 'Voz de Fern: desactivada',
    statDinners: 'Cenas',
