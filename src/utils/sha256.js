// Pure-JS SHA-256, no native module — avoids requiring an expo-crypto native
// rebuild just to hash a phone number locally before it ever leaves the device.
const K = [
...
export function sha256Hex(message) {
    ...
    // bitLength fits comfortably in the low 32 bits for any realistic input (phone numbers, tokens)
