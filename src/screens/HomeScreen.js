  ...
  return (
    <View style={styles.container}>
      ...
      <Modal
        ...
        onRequestClose={closeCharcuterieModal}
      >
        <View style={styles.charcuterieBackdrop}>
          <View style={styles.charcuterieSheet}>
            <TouchableOpacity style={styles.charcuterieCloseBtn} activeOpacity={0.85} onPress={closeCharcuterieModal}>
            ...
            >
              ...
              <TouchableOpacity style={styles.charcuterieBuildBtn} activeOpacity={0.85} onPress={handleBuildCharcuterieBoard}>
                <Text style={styles.charcuterieBuildBtnText}>🧀 Build My Board</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.charcuterieAskFernBtn} activeOpacity={0.85} onPress={handleAskFernCharcuterie}>
...
const styles = StyleSheet.create({
  ...
  charcuterieDietaryWrap: {
    marginTop: 10,
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 8,
  },
  charcuterieDietaryChip: {
    borderWidth: 1,
    borderColor: '#CFBFA7',
    borderRadius: 999,
    paddingHorizontal: 12,
  ...
  charcuterieDietaryChipActive: {
    backgroundColor: '#E96B1E',
    borderColor: '#E96B1E',
  },
  charcuterieDietaryChipText: {
    color: '#6D563F',
    fontFamily: 'Jost-Bold',
    fontSize: 12,
  },
  charcuterieDietaryChipTextActive: {
    color: '#FFF8EF',
  },
  charcuterieBuildBtn: {
    marginTop: 18,
